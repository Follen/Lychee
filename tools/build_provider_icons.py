...
preview.save(ROOT / 'docs/validation/2026-09-10-provider-icons.png')
(ROOT / 'docs/validation/2026-09-10-provider-icons.json').write_text(json.dumps(manifest, indent=2)+'\n')
