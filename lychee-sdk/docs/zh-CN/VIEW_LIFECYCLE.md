...
[目录](README.md) · [English](../en/VIEW_LIFECYCLE.md)

性能、容量与生命周期预算统一见[性能硬门禁](PERFORMANCE.md)；本页说明接口使用方式。

当前 SDK 为 1.0.0 / API 1.0.0，UI Runtime 为 1。资源见 [托管资源协议](MANAGED_RESOURCES.md)，本包数据库见 [Storage](STORAGE.md)，加载和数据就绪见 [LOADING](LOADING.md)。
