...
local API = { API_VERSION=3, API_REVISION=1, MIN_API_REVISION=1, ERROR_CODES={} }
for _, code in ipairs({
    ...
    "STORAGE_CLOSED", "STORAGE_BUSY", "STORAGE_NOT_READY", "STORAGE_EXISTS",
    "STORAGE_NEWER_VERSION", "STORAGE_MIGRATION_REQUIRED", "STORAGE_MIGRATION_MISSING", "STORAGE_MIGRATION_FAILED",
    "STORAGE_MIGRATION_LIMIT", "STALE_STORAGE", "CATALOG_CLOSED", "CATALOG_BUSY",
    "CATALOG_CANCELLED"
}) do
