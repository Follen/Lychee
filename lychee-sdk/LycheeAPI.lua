...
for _, code in ipairs({
    ...
    "ACTION_REQUIRES_INVOCATION", "AMBIGUOUS_INPUT", "CAPABILITY_CHANGED", "CATALOG_BUSY",
    "CATALOG_CANCELLED", "CATALOG_CLOSED", "EDIT_CLOSED", "INCOMPATIBLE_ACTION_VERSION",
    "INCOMPATIBLE_PRODUCT", "INCOMPLETE_INVOCATION", "INVALID_ARGUMENT", "INVALID_NUMBER",
    "INVALID_PRECISION", "INVALID_PREPARATION", "INVALID_REFERENCE", "INVALID_STEP",
    "INVALID_TARGET", "MISSING_ARGUMENT", "NON_IDEMPOTENT_ACTION", "OPERATION_BUSY",
    "OUT_OF_RANGE", "PENDING", "PREPARATION_UNAVAILABLE", "PREPARE_FAILED",
    "PREPARE_TIMEOUT", "PROVIDER_UNAVAILABLE", "SECURE_ACTION_REQUIRED", "STALE_PREPARATION",
    "STALE_PREPARED", "STALE_STORAGE", "STORAGE_BUSY", "STORAGE_CLOSED",
    "STORAGE_EXISTS", "STORAGE_MIGRATION_FAILED", "STORAGE_MIGRATION_LIMIT", "STORAGE_MIGRATION_MISSING",
    "STORAGE_MIGRATION_REQUIRED", "STORAGE_NEWER_VERSION", "STORAGE_NOT_READY", "TARGET_VIEW_UNAVAILABLE",
    "UNKNOWN_ARGUMENT", "UNKNOWN_ENUM"
}) do
