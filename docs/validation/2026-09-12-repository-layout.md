...
日期：2026-09-12。基础提交：55834e1。运行时业务、游戏插件名Lychee和公开API 2 / revision 7不变。
...
- `tools/build_sdk.py --check`与`tools/build_release.py --check`通过：插件137文件，SDK26文件。SDK附带的性能规范由根文件生成，所有本地文档链接在SDK内闭合。
