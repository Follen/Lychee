...
同一脚本读取归档旧源码和新源码，独立进程、相同输入、五轮交替。[原始输出](../architecture/2026-09-10-project-perf-search-results.json)
