...
[来源记录](../design/2026-09-10-tooltip-clipping-wowdoc.json) 含 SetParent、SetPoint 与 GameTooltip_OnHide 的 path/line/excerpt。开始修改前已读取同版本生成 API 和 Blizzard OnHide 实现；[静态结果](../design/2026-09-10-tooltip-clipping-validate.json)。
