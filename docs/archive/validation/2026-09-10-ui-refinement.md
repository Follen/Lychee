...
[查档原始记录](../design/2026-09-10-ui-refinement-wowdoc.json) 保存 path、line、excerpt。包括 SimpleFontStringAPIDocumentation.lua 的 SetFont（500）、SetShadowOffset（633）、GetStringHeight（325）；SimpleFrameAPIDocumentation.lua 的 SetClampedToScreen（1206）和 SetFrameStrata（1292）；SetPoint、SetParent 的生成 API 记录。所有修改前已读取对应证据。

[修改后静态验证](../design/2026-09-10-ui-refinement-validate.json)。
