local _,I=...
local L = I.ProviderLocales:ForProvider("lychee.blizzard-settings")
...
local M=C:New("lychee.blizzard-settings",L["暴雪设置"],{"ADDON_LOADED"},build,actions)
