local _,I=...
local L = I.ProviderLocales:ForProvider("lychee.keystones")
local C = I.Modules.CatalogProvider
local M
...
M=C:New("lychee.keystones",L["队伍钥匙"],{"GROUP_ROSTER_UPDATE","BAG_UPDATE_DELAYED","CHALLENGE_MODE_MAPS_UPDATE",
...
M.query=function(request,reply)
    -- Host routes the configured search entries. The package catalog supplies
