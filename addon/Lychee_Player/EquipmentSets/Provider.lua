local _,I=...
local L = I.ProviderLocales:ForProvider("lychee.equipment-sets")
...
I.Modules.EquipmentSets=C:New("lychee.equipment-sets",L["装备方案"],{"EQUIPMENT_SETS_CHANGED","PLAYER_EQUIPMENT_CHANGED"},equipment,
