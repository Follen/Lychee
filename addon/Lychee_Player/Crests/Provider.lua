local _,I=...
local L = I.ProviderLocales:ForProvider("lychee.crests")
local M = {}
I.Modules.Crests = M
...
function M:Init()
    ...
    local handle, err = I.Modules.Support:Register({
        id="lychee.crests", apiVersion=3,minApiRevision=1,i18n=L.resources, version="1.0.0", title=L["纹章"], scope=I.Modules.Support:Scope("lychee.crests"),
        catalog={{ id="crests", title=L["纹章"], kindTitle=L["角色货币"], icon=7734060,
