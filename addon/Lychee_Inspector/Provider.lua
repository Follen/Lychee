local _,I=...
local L = I.ProviderLocales:ForProvider("lychee.addon-inspector")
I.Modules=I.Modules or {}
local M={id="lychee.addon-inspector",epoch=0}
I.Modules.AddonInspector=M
...
local Picker=I.Modules.AddonInspectorPicker
...
function M:Start()
    ...
    self:Stop()
    self.view=self.view or I.CreateInspectorView(self)
    self.running=true
...
function M:Init()
    ...
    self.handle=I.Modules.Support:Register({id=self.id,apiVersion=3,minApiRevision=1,i18n=L.resources,version="1.0.0",title=L["插件识别"],scope=I.Modules.Support:Scope("lychee.addon-inspector"),
        catalog={{id="inspect",title=L["插件识别"],kindTitle=L["工具"],subtitle=L["指向界面，查看来自哪个插件"],
