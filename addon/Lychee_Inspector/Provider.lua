...
function M:Init()
    ...
    self.handle=I.Modules.Support:Register({id=self.id,apiVersion="1.0.0",i18n=L.resources,version="1.0.0",title=L["插件识别"],scope=I.Modules.Support:Scope("lychee.addon-inspector"),
