...
L:Add({
    ...
    ["少一点翻找，多一点冒险。"] = "Less searching. More adventuring.",
    ["将技能、物品与插件入口，收进一个搜索框。\n常用的入口、熟悉的名字，都按你的习惯留下。"] = "One search box for spells, items, and addons.\nKeep favorite shortcuts and names that feel familiar.",
    ["版本"] = "Version",
    ["作者"] = "Author",
