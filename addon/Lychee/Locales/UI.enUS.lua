...
L:Add({
    ...
    ["暂不可用"] = "Unavailable",
    ["正在恢复…"] = "Restoring…",
    ["插件已禁用"] = "Addon disabled",
    ["找不到来源"] = "Provider not found",
    ["目标已删除"] = "Target deleted",
    ["当前版本不兼容"] = "Incompatible version",
    ["恢复超时，请重新打开重试"] = "Restore timed out; reopen to retry",
    ["依赖插件不可用"] = "Dependency unavailable",
    ["目标暂不可用"] = "Target unavailable",
    ["恢复失败，请重新打开重试"] = "Restore failed; reopen to retry",
    ...
    ["搜索中…"] = "Searching…",
    ["重试"] = "Retry",
    ["部分来源暂不可用，请重新搜索"] = "Some sources are unavailable. Search again to retry.",
    ["取消固定"] = "Unpin",
    ...
    ["综合设置"] = "General",
    ["关于"] = "About",
    ["感谢使用荔枝"] = "Thanks for using Lychee",
    ["在游戏里搜技能、物品和插件设置。"] = "Search for spells, items and addon settings in WoW.",
...
L:Add({
    ...
    ["用 EX：搜索设置页面或解锁界面"]="Use EX: to find settings pages or unlock the layout",
    ...
    ["魔兽世界万用启动器"] = "Universal launcher for World of Warcraft",
    ["内置"] = "Built-in",
