...
L:Add({
    ...
    ["在一个搜索框里，找到技能、物品、成就和插件入口。"] = "Find spells, items, achievements, and addon shortcuts in one search box.",
    ["使用方式"] = "Getting started",
    ["搜索后点击使用，右键查看更多操作。\n常用内容可固定到首页，也可以设置自己的别名。"] = "Search and click to use. Right-click for more actions.\nPin favorites to Home, or give them your own aliases.",
    ["版本"] = "Version",
    ["作者"] = "Author",
