...
local L = I.ProviderLocales:Module("builtin.equipment-sets")
...
I.ProviderModules.EquipmentSets=C:New("builtin.equipment-sets",L["装备方案"],{"EQUIPMENT_SETS_CHANGED","PLAYER_EQUIPMENT_CHANGED"},equipment,
