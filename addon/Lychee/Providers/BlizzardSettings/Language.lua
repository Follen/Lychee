...
local G={};I.ProviderModules.SettingsLanguage=G
function G.Build(specs,checkpoint)
 for _,s in ipairs(specs) do
  ...
  if s.variable then
   ...
   local words=I.ProviderModules.SettingsAliases[s.variable] or s.cvar and I.ProviderModules.SettingsAliases[s.cvar] or {}
   if s.raid and s.cvar then words=I.ProviderModules.SettingsAliases[s.cvar:gsub("^raidGraphics","graphics")] or words end
