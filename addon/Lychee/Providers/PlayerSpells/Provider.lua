...
I.ProviderModules.PlayerSpells = I.ProviderModules.PlayerSpells or {}
local P = {
    items = {},
...
I.ProviderModules.PlayerSpells.Provider = P
P.aliasDefinitions = (I.ProviderData and I.ProviderData.PlayerSpellAliases) or {}
P.ledger=I.ProviderModules.CatalogLedger:New({
