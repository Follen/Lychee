...
local L = I.ProviderLocales:Module("builtin.crests")
local M = {}
I.ProviderModules.Crests = M
...
function M:Init()
    ...
    local handle, err = _G.Lychee:RegisterProvider({
        id="builtin.crests", apiVersion="1.0.0",i18n=L.resources, version="1.0.0", title=L["纹章"], scope=I.ProviderModules.Support:Scope("builtin.crests"),
