...
local L = I.ProviderLocales:Module("builtin.game-menus")
local A = I.ProviderModules.InterfaceActions
local M = {}
I.ProviderModules.GameMenus = M
...
function M:Init()
    ...
    local handle, err = _G.Lychee:RegisterProvider({
        id="builtin.game-menus", apiVersion="1.0.0",i18n=L.resources, version="1.0.0", title=L["游戏菜单"], scope=I.ProviderModules.Support:Scope("builtin.game-menus"), entries=records,
