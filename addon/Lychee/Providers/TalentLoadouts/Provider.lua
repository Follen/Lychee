...
local L = I.ProviderLocales:Module("builtin.talent-loadouts")
...
I.ProviderModules.TalentLoadouts=C:New("builtin.talent-loadouts",L["天赋方案"],
    {"TRAIT_CONFIG_UPDATED","TRAIT_CONFIG_LIST_UPDATED","PLAYER_SPECIALIZATION_CHANGED"},talents,{apply={title=L["应用方案"],run=applyTalent}})
function I.ProviderModules.TalentLoadouts:onEvent(event,unit)
