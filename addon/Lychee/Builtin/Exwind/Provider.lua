...
local L=I.ProviderLocales:Builtin("builtin.exwind")
local N=I.Search.Normalizer
local M={id="builtin.exwind"}
I.Builtin.Exwind=M
...
function M:Init()
    ...
    self.handle=_G.Lychee:RegisterProvider({id=self.id,title="Exwind",version="1.0.0",apiVersion="1.0.0",scope=I.Builtin.Support:Scope(self.id),i18n=L.resources,searchGlobal=false,searchPrefixes={"ex"},searchKeywords={},entries={},actions=actions,
