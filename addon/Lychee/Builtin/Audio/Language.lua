...
local language={
    ...
    zh={
        ...
        verb={"设置","設置","設定","设定","调整","調整","调节","調節","调","調"},
        subject={"把","将","將"},
        connector={"",":","为","為","到","成","至","设置为","设置到","设置成","設置為","設置到","設置成","设为","设成","设到","设定为","设定到","設定為","設定到","設為","設成","設到","调节为","调节到","调节至","調節為","調節到","調節至","调整为","调整到","调整至","調整為","調整到","調整至","调为","调到","调成","调至","調為","調到","調成","調至"},
