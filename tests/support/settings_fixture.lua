...
local files={"BlizzardSettings/Locales.lua","Audio/Locales.lua","Shared/CatalogProvider.lua","BlizzardSettings/Provider.lua","BlizzardSettings/Graphics.lua","BlizzardSettings/Adapter.lua","Audio/Language.lua","Audio/Adapter.lua","Audio/View.lua","Audio/Provider.lua","BlizzardSettings/Aliases.lua","BlizzardSettings/Language.lua","BlizzardSettings/Invocations.lua"}
local extra={"Core/InvocationRuntime.lua","PublicAPI/Invocation.lua"};for _,f in ipairs(files) do extra[#extra+1]="Builtin/"..f end
dofile("tests/support/runtime.lua").Load("provider",extra)
return {I=LycheeInternal,A=LycheeInternal.Builtin.SettingsAdapter,G=LycheeInternal.Builtin.SettingsLanguage,
 M=LycheeInternal.Builtin.BlizzardSettings,advance=advance,rows=rows,add=add,setting=setting,
