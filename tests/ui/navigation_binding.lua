...
assert(p.viewHost.panel.contentHeight==364 and p.frame:GetHeight()==476)
assert(p:ResizeView(sized,416) and p.viewHost.panel.contentHeight==416 and p.frame:GetHeight()==528)
assert(p:ResizeView(sized,1000) and p.frame:GetHeight()==542,"Host caps oversized view requests including the shared footer")
