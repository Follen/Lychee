...
folder=root/"assets/data/raid-journal"
...
script=r'''LycheeInternal={ProviderModules={}};dofile("addon/Lychee/Providers/Bosses/JournalCatalog.lua")
local c=LycheeInternal.ProviderModules.JournalCatalog
