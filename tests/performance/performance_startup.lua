...
dofile("tests/support/runtime.lua").Load("provider", {"../Lychee_Player/Crests/Locales.lua", "../Lychee_Player/GameMenus/Locales.lua", "../Lychee_Encounters/Bosses/Locales.lua", "../Lychee_Player/Mounts/Locales.lua", "../Lychee_Player/Runtime/CatalogProvider.lua", "../Lychee_Player/Runtime/CatalogLedger.lua", "../Lychee_Player/Runtime/InterfaceActions.lua", "../Lychee_Encounters/Runtime/CatalogProvider.lua", "../Lychee_Encounters/Runtime/CatalogLedger.lua", "../Lychee_Encounters/Runtime/InterfaceActions.lua", "Search/ProviderPolicy.lua", "Core/Scheduler.lua", "../Lychee_Encounters/Bosses/JournalCatalog.lua", "../Lychee_Player/Crests/Provider.lua", "../Lychee_Player/GameMenus/Provider.lua", "../Lychee_Encounters/Bosses/Provider.lua", "../Lychee_Player/Mounts/Provider.lua", }, {root=(baselineRoot and baselineRoot~="" and baselineRoot.."/" or "").."addon/Lychee/"})
