...
print(string.format("provider perf: disabled scans=%d unchanged commits=%d unrelated scans=%d frames after reenable=%d late scans=%d; frames after 20 more toggles=%d; 100 unchanged refresh %.3fms %.1fKiB allocated %.1fKiB retained growth",disabledScans,redundant,unrelated,reuse,late,frames,ms,allocation,retained))
