...
dofile(root.."/Providers/PlayerSpells/Init.lua")
local module=LycheeInternal.ProviderModules.PlayerSpells
...
print('Provider lifecycle/incremental regression PASS')
