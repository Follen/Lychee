...
dofile("addon/Lychee/".."Providers/Achievements/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/Achievements/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/AddonInspector/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/AddonInspector/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/Bags/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/Bags/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/BlizzardSettings/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/BlizzardSettings/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/Bosses/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/Bosses/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/Crests/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/Crests/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/EquipmentSets/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/EquipmentSets/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/GameMenus/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/GameMenus/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/GreatVault/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/GreatVault/Locales/zhCN.lua")
dofile("addon/Lychee/".."Providers/Keystones/Locales/enUS.lua");dofile("addon/Lychee/".."Providers/Keystones/Locales/zhCN.lua")
