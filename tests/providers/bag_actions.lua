...
dofile("addon/Lychee/".."Providers/Achievements/Locales.lua")
dofile("addon/Lychee/".."Providers/AddonInspector/Locales.lua")
dofile("addon/Lychee/".."Providers/Bags/Locales.lua")
dofile("addon/Lychee/".."Providers/BlizzardSettings/Locales.lua")
dofile("addon/Lychee/".."Providers/Bosses/Locales.lua")
dofile("addon/Lychee/".."Providers/Crests/Locales.lua")
dofile("addon/Lychee/".."Providers/EquipmentSets/Locales.lua")
dofile("addon/Lychee/".."Providers/GameMenus/Locales.lua")
dofile("addon/Lychee/".."Providers/GreatVault/Locales.lua")
dofile("addon/Lychee/".."Providers/Keystones/Locales.lua")
dofile("addon/Lychee/".."Providers/Mounts/Locales.lua")
dofile("addon/Lychee/".."Providers/PlayerSpells/Locales.lua")
dofile("addon/Lychee/".."Providers/TalentLoadouts/Locales.lua")
