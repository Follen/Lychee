...
dofile("tests/support/runtime.lua").Load("provider", {"Providers/Achievements/Locales.lua", "Providers/AddonInspector/Locales.lua", "Providers/Bags/Locales.lua", "Providers/BlizzardSettings/Locales.lua", "Providers/Bosses/Locales.lua", "Providers/Crests/Locales.lua", "Providers/EquipmentSets/Locales.lua", "Providers/GameMenus/Locales.lua", "Providers/GreatVault/Locales.lua", "Providers/Keystones/Locales.lua", "Providers/Mounts/Locales.lua", "Providers/PlayerSpells/Locales.lua", "Providers/TalentLoadouts/Locales.lua", "Search/ProviderPolicy.lua", "Core/Scheduler.lua", "Core/ResultActionExecutor.lua", "Providers/Shared/CatalogProvider.lua", "Providers/Bags/Provider.lua", "Providers/TalentLoadouts/Provider.lua", "Providers/EquipmentSets/Provider.lua", "Providers/BlizzardSettings/Provider.lua", "Providers/Keystones/Provider.lua", "Providers/Init.lua"})
...
local modules={I.ProviderModules.Bags,I.ProviderModules.TalentLoadouts,I.ProviderModules.EquipmentSets,I.ProviderModules.BlizzardSettings,I.ProviderModules.Keystones}
local metrics={}
...
assert(action(I.ProviderModules.BlizzardSettings,"cdm","cdm").ok and calls.cdm)
bags[1],bags[2]=bags[2],bags[1]
assert(action(I.ProviderModules.Bags,"locate","item:1").ok and calls.bagSearch=="")
bags[2]=nil
assert(not action(I.ProviderModules.Bags,"locate","item:1").ok,"stale slot must not act on another item")
event(I.ProviderModules.Bags,"BAG_UPDATE_DELAYED");drain()
assert(not I.Providers.entries["builtin.bags"].recordMap["item:1"])
assert(action(I.ProviderModules.TalentLoadouts,"apply","talent:2").ok and calls.talent==2)
talentIDs={1};assert(not action(I.ProviderModules.TalentLoadouts,"apply","talent:2").ok)
assert(action(I.ProviderModules.EquipmentSets,"equip","equipment:2").ok and calls.gear==2)
local keys=I.ProviderModules.Keystones
...
local b=I.ProviderModules.Bags
