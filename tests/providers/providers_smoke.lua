...
dofile("tests/support/runtime.lua").Load("provider", {"Providers/Achievements/Locales.lua", "Providers/AddonInspector/Locales.lua", "Providers/Bags/Locales.lua", "Providers/BlizzardSettings/Locales.lua", "Providers/Bosses/Locales.lua", "Providers/Crests/Locales.lua", "Providers/EquipmentSets/Locales.lua", "Providers/GameMenus/Locales.lua", "Providers/GreatVault/Locales.lua", "Providers/Keystones/Locales.lua", "Providers/Mounts/Locales.lua", "Providers/PlayerSpells/Locales.lua", "Providers/TalentLoadouts/Locales.lua", "Providers/Shared/CatalogProvider.lua", "Search/ProviderPolicy.lua", "Core/Scheduler.lua", "UI/Theme.lua", "UI/TextHighlight.lua", "UI/ViewHost.lua", "Core/ResultActionExecutor.lua", "Providers/Shared/InterfaceActions.lua", "Providers/Bosses/JournalCatalog.lua", "Providers/Crests/Provider.lua", "Providers/GameMenus/Provider.lua", "Providers/Bosses/Provider.lua", "Providers/Init.lua"})
...
assert(I.ProviderModules.Crests.handle and I.ProviderModules.GameMenus.handle and I.ProviderModules.Bosses.handle, "all providers register through API 1.0.0")
...
assert(I.ProviderModules.Crests.handle:SetAvailability(false))
assert(not next(panel.frame.events) and not panel.active, "provider disable releases currency events")
assert(I.ProviderModules.Crests.handle:SetAvailability(true))
host:Unmount("test")
...
assert(#I.Providers.entries["builtin.bosses"].records==I.ProviderModules.JournalCatalog.encounterCount)
...
print(string.format("Built-in providers PASS: %d bosses; init %.2f ms / retained %.1f KiB; alternating query mean %.3f ms (offline Lua only)",
    I.ProviderModules.JournalCatalog.encounterCount,initMS,indexKB,(os.clock()-queryStarted)*10))
