...
dofile("tests/support/runtime.lua").Load("provider", {"../Lychee_Player/Achievements/Locales.lua", "../Lychee_Inspector/Locales.lua", "../Lychee_Player/Bags/Locales.lua", "../Lychee_Player/BlizzardSettings/Locales.lua", "../Lychee_Encounters/Bosses/Locales.lua", "../Lychee_Player/Crests/Locales.lua", "../Lychee_Player/EquipmentSets/Locales.lua", "../Lychee_Player/GameMenus/Locales.lua", "../Lychee_Player/GreatVault/Locales.lua", "../Lychee_Player/Keystones/Locales.lua", "../Lychee_Player/Mounts/Locales.lua", "../Lychee_Player/PlayerSpells/Locales.lua", "../Lychee_Player/TalentLoadouts/Locales.lua", "../Lychee_Player/Runtime/CatalogProvider.lua", "../Lychee_Player/Runtime/CatalogLedger.lua", "../Lychee_Player/Runtime/InterfaceActions.lua", "../Lychee_Encounters/Runtime/CatalogProvider.lua", "../Lychee_Encounters/Runtime/CatalogLedger.lua", "../Lychee_Encounters/Runtime/InterfaceActions.lua", "Core/Scheduler.lua", "UI/Theme.lua", "UI/Runtime.lua", "UI/Components.lua", "../Lychee_Inspector/View.lua", "../Lychee_Inspector/Picker.lua", "../Lychee_Inspector/Provider.lua"})
