...
dofile("tests/support/runtime.lua").Load("provider", {"Providers/Achievements/Locales.lua", "Providers/AddonInspector/Locales.lua", "Providers/Bags/Locales.lua", "Providers/BlizzardSettings/Locales.lua", "Providers/Bosses/Locales.lua", "Providers/Crests/Locales.lua", "Providers/EquipmentSets/Locales.lua", "Providers/GameMenus/Locales.lua", "Providers/GreatVault/Locales.lua", "Providers/Keystones/Locales.lua", "Providers/Mounts/Locales.lua", "Providers/PlayerSpells/Locales.lua", "Providers/TalentLoadouts/Locales.lua", "Providers/Shared/CatalogProvider.lua", "Secure/Descriptor.lua", "Secure/Policy.lua", "Providers/Shared/InterfaceActions.lua", "Providers/Mounts/Provider.lua", "Providers/GreatVault/Provider.lua", "Providers/Init.lua"})
local I, M = LycheeInternal, LycheeInternal.ProviderModules.Mounts
...
C_MountJournal=journal
I.ProviderModules:Init(); I.Registry:SetReady(true); flush()
assert(M.handle and I.ProviderModules.GreatVault.handle, "both providers are wired by ProviderModules.Init")
...
local vault=I.ProviderModules.GreatVault
