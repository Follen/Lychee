...
dofile("tests/support/runtime.lua").Load(nil, {"Bootstrap.lua", "Core/CharacterStore.lua", "Providers/Definitions.lua", "Providers/Shared/Support.lua", "Core/ProviderLocales.lua", "Core/ContextStore.lua", "Search/Normalizer.lua", "Search/StaticIndex.lua", "Search/QueryOrchestrator.lua", "Search/SearchSession.lua"})
