...
dofile("tests/support/runtime.lua").Load("provider",{"Search/ProviderPolicy.lua",
    "Builtin/Ellesmere/Locales.lua","Builtin/Ellesmere/Adapter.lua","Builtin/Ellesmere/Provider.lua",
    "Builtin/Exwind/Locales.lua","Builtin/Exwind/Provider.lua"})
local I=LycheeInternal
I.Registry:SetReady(true)
I.Builtin.Ellesmere:Init();I.Builtin.Exwind:Init()
...
for _,id in ipairs({"builtin.ellesmere","builtin.exwind"}) do
    ...
    if other then
        ...
        local module=id=="builtin.ellesmere" and I.Builtin.Ellesmere or I.Builtin.Exwind
