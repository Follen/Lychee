...
_G.LycheeInternal.ProviderModules.PlayerSpells.Provider:Refresh()
...
assert(_G.LycheeInternal.ProviderModules.PlayerSpells.Provider:Refresh() == false)
...
local playerSpells = _G.LycheeInternal.ProviderModules.PlayerSpells
