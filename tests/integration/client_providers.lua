-- Real package modules under a bounded client fixture, with isolated locales.
...
dofile("tests/support/runtime.lua").Load("provider",{"../Lychee_Player/PlayerSpells/Locales.lua","../Lychee_Encounters/Bosses/Locales.lua","../Lychee_Player/Runtime/CatalogProvider.lua", "../Lychee_Player/Runtime/CatalogLedger.lua", "../Lychee_Player/Runtime/InterfaceActions.lua", "../Lychee_Encounters/Runtime/CatalogProvider.lua", "../Lychee_Encounters/Runtime/CatalogLedger.lua", "../Lychee_Encounters/Runtime/InterfaceActions.lua",})
...
load("../Lychee_Player/Runtime/CatalogLedger.lua")
...
load("../Lychee_Player/Runtime/InterfaceActions.lua");load("../Lychee_Player/GameMenus/Provider.lua")
...
load("../Lychee_Player/Runtime/CatalogProvider.lua");load("../Lychee_Player/BlizzardSettings/Provider.lua")
for _,client in ipairs({"retail","classic","titan","anniversary"}) do
...
print("client providers: locale isolation, legacy spells, four-client menus/settings and native boss names passed")
