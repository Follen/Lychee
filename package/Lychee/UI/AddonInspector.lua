...
function UI.CreateAddonInspector(owner)
    ...
    function view:Layout()
        ...
        for _,b in ipairs({self.copy,self.parent}) do
            local x=b==self.copy and 10 or 208
        ...
        self.footer:SetText(self.copying and "Ctrl+C 复制 · Esc 退出识别" or (sourceSetting=="0" and "来源记录未开启 · Shift 展开 · Esc 退出" or "按住 Shift 展开详情 · Esc 退出"))
